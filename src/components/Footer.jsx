...
function Footer() {
    ...
    return(
        ...
        <footer class=" bottom-0 bg-[url('./images/img.jpg')] bg-cover bg-center">
        ...
        <div className="flex ">
            ...
            <div class="flex flex-row justify-between text-white items-center px-9 py-4">
                ...
                <span class="text-lg font-normal  text-gray-400">© 2024 <a href="https://flowbite.com/" class="text-white font-semibold hover:underline ">IntellVision </a> All Rights Reserved.
                </span>
            
                <ul class="flex text-lg font-semibold gap-2">
                    <li>
                        <a href="#" class="hover:text-teal-400 me-4  ">Home</a>
                    </li>
                    <Divider color="#bdbdbd" orientation="vertical" flexItem  />

                    <li>
                        <a href="#" class="hover:text-teal-400  me-4  ">About</a>
                    </li>
                    <Divider color="#bdbdbd" orientation="vertical" flexItem />
